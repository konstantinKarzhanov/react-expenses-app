        ...
        <div className="page">
          <div className="about-container">
            <p className="info-text">
              ...
              well as individual transactions. It will then take said
              transactions and categorize them so the user can see how much of
              their budget is currently used and what it has been spent on so
              far.
            </p>
            <p className="info-text">
              Code Authors:
